...
const createHtmlContactAdmin = (user, text) => {
    if(user) {
        const htmlContent = `
            <!DOCTYPE html>
            <html>
                                        ...
                                        <td>
                                            ...
                                            <table width="100%" cellspacing="0" cellpadding="20" border="0">
                                                <tr style="background-color: #fff; width: 100%;">
                                                    <td colspan="3">
                                                        <h3>${user.pseudo} nous a envoyé un message :</h3>
                                                        <p style="border-bottom: 1px solid black;"></p>
                                                        <p>${text}</p>
                                                        <p style="border-bottom: 1px solid black;"></p>
                                                        <p>Nous devrions lui répondre dans les plus brefs délais !</p>
                                                    </td>
                                                </tr>
                                            </table>
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <table width="100%" cellspacing="0" cellpadding="20" border="0">
                                                <tr style="background-color: #fff; width: 100%;">
                                                    <td colspan="3">
                                                        <h3>Nous a envoyé un message :</h3>
                                                        <p style="border-bottom: 1px solid black;"></p>
                                                        <p>${text}</p>
                                                        <p style="border-bottom: 1px solid black;"></p>
                                                        <p>Nous devrions lui répondre dans les plus brefs délais !</p>
...
module.exports = createHtmlContactAdmin ;